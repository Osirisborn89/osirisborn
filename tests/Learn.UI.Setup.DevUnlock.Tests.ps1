...
Describe "Setup lesson quiz + DEV unlock presence" {
  ...
  It "loader has dev unlock hook" {
    $loader = "C:\Users\day_8\dev\osirisborn\MythicCore\www\js\langs.loader.js"
    Test-Path -LiteralPath $loader | Should -BeTrue
    (Get-Content -Raw -LiteralPath $loader) | Should -Match "dev=unlock"
  }
}